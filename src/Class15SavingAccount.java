public class Class15SavingAccount {

	public int accounNo;
	public float balance;

	// Always add default constructor.
	public Class15SavingAccount() {
		super();
	}

	// always initialize variable in super class so other subclass can use it.
	public Class15SavingAccount(int accounNo, float balance) {
	...
	// // Method OverLoading.
	protected void withdrawal(float withdrawalAmt, int pincode) {
		// business logic.
		System.out.println("Withdrwa() operating on Account:" + this.accounNo);
