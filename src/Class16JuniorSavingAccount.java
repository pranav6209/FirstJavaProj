public class Class16JuniorSavingAccount extends Class16SavingAccount {

	public Class16JuniorSavingAccount() {

		// if we remove super constructor will still add super. so it is alway
		// necessary to add default constructor in parent class.
		super();
		// TODO Auto-generated constructor stub
	}

	public Class16JuniorSavingAccount(int accounNo, float balance) {
